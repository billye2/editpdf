...
const GLYPH_NAMES: Record<string, string> = {
  ...
  guilsinglleft: '‹', guilsinglright: '›', guillemotleft: '«',
  guillemotright: '»', fi: 'ﬁ', fl: 'ﬂ', florin: 'ƒ',
  fraction: '⁄', trademark: '™', minus: '−', degree: '°',
  copyright: '©', registered: '®', section: '§',
  paragraph: '¶', cent: '¢', sterling: '£', yen: '¥',
  Euro: '€', currency: '¤', exclamdown: '¡', questiondown: '¿',
  periodcentered: '·', middot: '·', multiply: '×', divide: '÷',
  plusminus: '±', onehalf: '½', onequarter: '¼',
  threequarters: '¾', mu: 'µ', nbspace: ' ',
  circumflex: 'ˆ', tilde: '˜', caron: 'ˇ', breve: '˘',
  dotaccent: '˙', ring: '˚', ogonek: '˛', hungarumlaut: '˝',
  cedilla: '¸', dieresis: '¨', macron: '¯', acute: '´',
  brokenbar: '¦', logicalnot: '¬', ordfeminine: 'ª',
  ordmasculine: 'º', dotlessi: 'ı',
  Aacute: 'Á', Agrave: 'À', Acircumflex: 'Â', Adieresis: 'Ä',
  Atilde: 'Ã', Aring: 'Å', AE: 'Æ', Ccedilla: 'Ç',
  Eacute: 'É', Egrave: 'È', Ecircumflex: 'Ê', Edieresis: 'Ë',
  Iacute: 'Í', Igrave: 'Ì', Icircumflex: 'Î', Idieresis: 'Ï',
  Eth: 'Ð', Ntilde: 'Ñ', Oacute: 'Ó', Ograve: 'Ò',
  Ocircumflex: 'Ô', Odieresis: 'Ö', Otilde: 'Õ', Oslash: 'Ø',
  ...
  OE: 'Œ', oe: 'œ', Ydieresis: 'Ÿ', Lslash: 'Ł',
  lslash: 'ł',
};
